...
- [x] : 자동차 이름이 쉼표(,)를 기준으로 들어왔는지
- [x] : 자동차 이름이 1자 미만인 경우 예외를 던진다.
- [x] : 자동차 이름이 5자를 초과하는 경우 예외를 던진다.
- [x] : 시도할 횟수가 0 이하인 경우 예외를 던진다.
- [x] : 시도할 횟수가 숫자가 아닌 경우 예외를 던진다.
- [x] : 중복된 자동차 이름이 들어오는 경우 예외를 던진다.
